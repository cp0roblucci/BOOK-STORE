...
@section('content')
  <div class="mb-2">
    ...
    <div class="py-4 pt-2 ml-2 text-24 font-sora text-[#5432a8]">Create new @extends('admin.layout.main')
      ...
      @section('content')
        <div class="mb-2">
          ...
          <div class="py-4 pt-2 ml-2 text-24 font-sora text-[#5432a8]">Create new Accessories Type</div>
          <div class="">
