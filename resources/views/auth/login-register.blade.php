...
<body class="scrollbar-thin scroll-smooth scrollbar-thumb-rounded-lg scrollbar-thumb-blue-200 scrollbar-track-gray-100">
  ...
  <div class="app p-2 h-screen relative">
    ...
    <div
      ...
      class="w-[50%] h-[96%] mt-0.5 rounded-xl absolute bg-cover translate-x-[96%] transform transition-all ease-linear duration-700">
    </div>
      ...
      <div class="grid grid-cols-2 gap-8 h-full">
        ...
        <div id="formLogin" class="login flex w-[70%] h-[90%] mt-[5%] ml-8">
          <div class="p-6 w-full">
            ...
            <form action="{{ route('login') }}" method="post">
              ...
              <div class="w-full ">
                ...
                <div class="w-full relative">
                  ...
                  >
                  <i id="iconHidePassLogin" class="fa-regular fa-eye-slash absolute text-14 -translate-x-10 translate-y-3.5 cursor-pointer text-slate-500"></i>
                  <i id="iconShowPassLogin" class="fa-regular fa-eye hidden absolute text-14 -translate-x-10 translate-y-3.5 cursor-pointer text-slate-500"></i>
                </div>
              </div>
            ...
            <div class="mt-8 text-center text-14">
              <h4>
                Don't have an account?
                <button id="signUp" class="text-blue-200">Sign up</button>
              </h4>
            </div>
        ...
        <div id="formRegister" class="register flex w-[70%] h-full mx-[148px] ">
          <div class="px-6 py-2 w-full">
            <div class="mb-4">
              ...
              <h6 class="text-16 text-center text-slate-400">or</h6>
            </div>
            <form action="{{ route('register') }}" method="post">
              ...
              <div class="flex flex-col w-full">
                <div class="grid grid-cols-2 gap-2 mb-4">
                  ...
                  class="p-[10px] text-14 outline-none placeholder:text-slate-300 rounded-lg border border-slate-300 focus-within:border-purple-500"
                  >
                  <input
                    type="text"
                    name="firstname"
                ...
                <input
                  ...
                  class="mb-4 p-[10px] text-14 outline-none appearance-none placeholder:text-slate-300 rounded-lg border border-slate-300 focus-within:border-purple-500"
                >
                <input
                  type="email"
                  name="email"
                  placeholder="Email"
                  class="mb-4 p-[10px] text-14 outline-none placeholder:text-slate-300 rounded-lg border border-slate-300 focus-within:border-purple-500"
                >
                <div class="w-full relative">
                  <input
                    id="passRegister"
                    ...
                    name="password"
                    placeholder="Password"
                    class="w-full mb-4 p-[10px] text-14 outline-none placeholder:text-slate-300 rounded-lg border border-slate-300 focus-within:border-purple-500"
                  >
                  <i id="iconHidePassRegister" class="fa-regular fa-eye-slash absolute text-14 -translate-x-10 translate-y-3.5 cursor-pointer text-slate-500"></i>
                  <i id="iconShowPassRegister" class="fa-regular fa-eye hidden absolute text-14 -translate-x-10 translate-y-3.5 cursor-pointer text-slate-500"></i>
                </div>
                <div class="w-full relative ">
                  <input
                    ...
                    class="w-full mb-4 p-[10px] text-14 outline-none placeholder:text-slate-300 rounded-lg border border-slate-300 focus-within:border-purple-500"
                  >
                  <i id="iconHideConfirmPass" class="fa-regular fa-eye-slash absolute text-14 -translate-x-10 translate-y-3.5 cursor-pointer text-slate-500"></i>
                  <i id="iconShowConfirmPass" class="fa-regular fa-eye hidden absolute text-14 -translate-x-10 translate-y-3.5 cursor-pointer text-slate-500"></i>
                </div>
              </div>
                <div class="flex mb-4 relative">
                  <input
                  ...
                  >
                  <label for="rememberMe" class="text-slate-600 text-14 ml-2">
            ...
            <div class="mt-4 text-center text-14">
              <h4>
                ...
                <button id="signIn" class="text-purple-400">Sign in</button>
              </h4>
            </div>
