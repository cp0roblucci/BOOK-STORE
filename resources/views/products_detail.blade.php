...
@section('body')
    @if(strpos($detail[0]->id, 'ARM') !== false)
    <section class="px-20 py-4 bg-white">
        <div class="bg-white">
            <div class="flex ">
                <div class="flex flex-col w-1/2">
                    <img src="{{$detail[0]->accessories_link_img}}" alt="" 
                    class="py-6 px-10">
                ...
                <div class="flex flex-col w-1/2 mr-16  mt-4" data-key="1">
                    <div class="">
                        <h2 class="text-24 font-semibold mb-2">{{$detail[0]->accessories_name}}</h2>
                        <div class="flex text-sm font-semibold">
                            <p class="mr-2">SKU: </p> 
                            <span class="text-red-500">{{$detail[0]->id}}</span>
                            <p class="mx-4">|</p>
                    ...
                    <div class="price flex mt-6">
                        ...
                        <span class="text-red-500 text-20 font-bold">{{number_format($detail[0]->accessories_price, 0, '', '.')}}đ</span>
        ...
        <div class="bg-white">
            <div class="flex ">
                ...
                <div class="flex flex-col w-1/2 mr-16  mt-4" data-key="1">
                    ...
                    <div class="price flex mt-6">
                        <span class="text-red-500 mr-2 font-bold text-20">Giá:</span>
                        <span class="text-red-500 text-20 font-bold">{{number_format($detail[1]->has_price, 0, '', '.')}}đ</span>
                        {{-- <span class="block ml-2 opacity-70 mt-1 line-through text-sm">60000d</span> --}}
                    </div>
                    {{-- <div class="flex text-sm mt-1 font-semibold">
                        <span class="text-gray-700">Tiết kiệm:</span>
