                ...
                <div class="border border-white h-24  rounded-xl bg-gradient-to-br from-[#ffffff55] to-[#ffffff20]">
                  <div class="p-2 flex items-center justify-between">
                    ...
                    <div class="flex flex-col text-white">
                      ...
                      <span class="font-bold mt-6 text-20">{{ $sach}}+</span>
                    </div>
                    <div class="mr-10">
                            ...
                            <tbody>
                              ...
                              <tr class="border-t ">
                                ...
                                <td class="p-2 bg-transparent text-left">
                                  <div class="px-2 py-1">
                                    <span class="mb-0 text-sm leading-normal">{{ $customer->ND_Ten }}</span>
                                  </div>
                                </td>
                                <td class="p-2 bg-transparent text-left">
                                  <div class="px-2 py-1">
                                ...
                                <td class="p-2 bg-transparent">
                                  <div class="px-2 py-1">
                                    <h6 class="mb-0 text-sm leading-normal">{{ $customer->ND_Email}}</h6>
                                  </div>
                                </td>
                                <td class="p-2 bg-transparent">
                                  <div class="px-2 py-1">
                              ...
                              <tr class="border-t ">
                                ...
                                <td class="p-2 bg-transparent text-left">
                                  <div class="px-2 py-1 w-[180px]">
                                    <h6 class="mb-0 text-sm leading-normal truncate">{{ $product->DM_Ten}}</h6>
                                  </div>
                                </td>
                                <td class="p-2 bg-transparent">
                                  <div class="px-2 py-1 text-center">
              ...
              <div class="col-span-2 rounded-2xl">
                <div class="flex flex-wrap -mx-3">
                  <div class="flex flex-col w-full max-w-full px-3">
                    ...
                    <div class="flex flex-col w-full h-full border border-primary-blue mb-2 shadow-md bg-slate-50 rounded-2xl">
                      <div class="p-6 pt-4 pb-2">
                        <h3 class="text-[#344767] uppercase text-18 text-primary-blue font-thin">Danh Mục Bán Nhiều Nhất</h3>
                      </div>
                          ...
                          <table class="items-center w-full mb-0 align-top border-collapse text-slate-500">
                            ...
                            <tbody>
                              ...
                              <tr class="border-t ">
                                ...
                                <td class="p-2 bg-transparent text-left">
                                  <div class="px-2 py-1">
                                    <h6 class="mb-0 text-sm leading-normal">{{ $product->DM_Ten}}</h6>
                                  </div>
                                </td>
                    ...
                    <div class="flex flex-col w-full h-full border border-primary-blue  shadow-md bg-slate-50 rounded-2xl">
                      <div class="p-6 pt-4 pb-2">
                        <h3 class="text-[#344767] uppercase text-18 text-primary-blue font-thin">Danh Mục Bán Ít Nhất</h3>
                      </div>
