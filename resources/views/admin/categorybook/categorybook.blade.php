                  ...
                  <table class="items-center w-full mb-0 align-top border-collapse text-slate-500">
                    <thead class="align-bottom bg-slate-200 rounded-2xl">
                      <tr class="text-black uppercase text-left text-12">
                        ...
                        <th class="px-4 py-3 font-bold">Phân Cấp Danh Mục</th>
                        <th class="px-4 py-3 font-bold text-center"></th>
                      </tr>
                    </thead>
                    <tbody>
                      @foreach($data as $key => $categorybook)
                        <tr class="border-t even:bg-gray-100 odd:bg-white">
                          ...
                          <td class="p-4 bg-transparent text-left">
                            <div class=" py-1">
                                <h6 class="mb-0 text-sm leading-normal">{{$categorybook->DM_Ten}}</h6>
                            </div>
                          </td>
                          <td class="p-4 bg-transparent">
                            <div class="py-1">
                              <h6 class="mb-0 text-sm leading-normal ml-2">
                                  @if($categorybook->DM_PhanCap == 1)
                                      Sách Tiếng Việt
                                  @elseif($categorybook->DM_PhanCap == 2)
                                      Sách Tiếng Anh
                                  @endif
                              </h6>
                          </div>
                          ...
                          <td class="flex bg-transparent mt-4 justify-center items-center ">
                            ...
                            <a href="update-categorybook/{{$categorybook->DM_Ma}}/update" class="text-16 mr-4 text-blue-500">
                            ...
                            {{-- <button class="delete-fish text-16 mr-2 text-red-300 cursor-pointer" data-id="{{$fish->fish_id}}"> --}}
                              <button class="delete-categorybook text-12 text-red-400 leading-normal border-2 border-red-400  px-4 py-2 rounded-xl hover:bg-red-400  hover:text-white transition-all duration-200 " data-id="{{$categorybook->DM_Ma}}">Xóa</button>
                          </td>
                        </tr>
                      @endforeach
                    </tbody>
