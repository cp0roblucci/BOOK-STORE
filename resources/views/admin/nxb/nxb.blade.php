...
@section('path', 'Sản phẩm / Nhà Xuất Bản')
          ...
          <div class="flex flex-col w-full max-w-full px-3">
            <div class="flex flex-col min-w-[980px] mb-6 bg-white border-0 shadow-md rounded-lg ">
              <div class="flex p-2 py-2 items-center justify-between mb-1 mt-1">
                <h3 class="text-[#344767] text-20 font-sora">Danh sách Nhà Xuất Bản</h3>
                <a href="{{route('admin-new-nxb')}}" class="border pr-4 pl-2 py-2 hover:bg-slate-100 hover:text-primary-blue transition-all">
                  ...
                  <table class="items-center w-full mb-0 align-top border-collapse text-slate-500">
                    <thead class="align-bottom bg-slate-200 rounded-2xl">
                      <tr class="text-black uppercase text-left text-12">
                        ...
                        <th class="px-2 py-3 font-bold ">Tên Nhà Xuất Bản</th>
                      ...
                      @foreach($data as $key => $nxb)
                        <tr class="border-t even:bg-gray-100 odd:bg-white">
                          ...
                          <td class="p-2.5 bg-transparent text-left">
                            <div class=" py-1">
                                <h6 class="mb-0 text-12 leading-normal">{{$nxb->NXB_Ten}}</h6>
                            </div>
                          </td>
                          <td class="p-1 bg-transparent">
                            <div class="py-1">
                              <h6 class="mb-0 text-12 leading-normal ">{{$nxb->NXB_DiaChi}}</h6>
                            </div>
                          </td>
                          ...
                          <td class="flex bg-transparent mt-4 justify-center items-center ">
                            ...
                            <a href="update-nxb/{{$nxb->NXB_Ma}}/update" class="text-16 mr-4 text-blue-500">
                            ...
                            {{-- <button class="delete-fish text-16 mr-2 text-red-300 cursor-pointer" data-id="{{$fish->fish_id}}"> --}}
                              <button class="delete-nxb text-12 text-red-400 leading-normal border-2 border-red-400  px-4 py-2 rounded-xl hover:bg-red-400  hover:text-white transition-all duration-200 " data-id="{{$nxb->NXB_Ma}}">Xóa</button>
                          </td>
                        </tr>
                      @endforeach
                    </tbody>
